...
ohe=OneHotEncoder(categorical_features=[0,6,15,16])
...
ann =Sequential()
ann.add(Dense(15,input_shape=(29,),activation='relu'))
...
type3df:5
"""
new = [['M',65,21,30,7,8,'junk',5,3,5,3,5,3,5,3,'summer','urban',3,5,3,5,3,5]]
new=np.array(new)
